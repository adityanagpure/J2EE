    ...
    <div class="container col-8 col-md-4 rounded bg-light"
      ...
      <div class="row">
        <div class="col-12  p-3 ">
          <div>
            <div>
              <h2 class="text-danger tex">Add New Admin </h2>
            </div>
            <form action="addAdminProcess" method="post" class="was-validated">
              <div class="form-group">
                <label for="user" class="font-weight-bold mt-2"> Enter Username: </label>
                <input name="userName" class="form-control" minlength="5" maxlength="8" required />
                <span id="username" class="text-danger font-weight-bold"> </span>
              </div>

              <div class="form-group">
                <label for="user" class="font-weight-bold mt-2"> Enter userPass: </label>
                <input name="userPass" type="password" class="form-control" minlength="8"  required/>
                <span id="username" class="text-danger font-weight-bold"> </span>
              </div>
