    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-6  d-flex flex-column justify-content-center align-items-center" style="height: 100vh;">
                ...
                <h2 class="text-danger">PASSWORD SENT SUCCESFULL....!!</h2>

                <h5>We have sent a Password to your register mail-id</h5>

                <button class=" mt-2 btn btn-outline-danger" >
              <a class="nav-link" href="Home.jsp">Back to Home </a></button>
            </div>
        </div>
    </div>
